...
For use in the McGill University physics department .
...
class rtd_monitor(_g.BaseObject):
    ...
    def populate_window(self, ports, default_port, show, block):
        ...
        self.grid_params = self.grid_1.place_object(_g.GridLayout(margins=False),alignment=0)
        self.grid_temperature = self.grid_1.place_object(_g.GridLayout(margins=False),alignment=0)
        ...
        self.grid_temperature.add(_g.Label('Temperature:'), alignment=2).set_style(style_1)
        self.number_temperature = self.grid_temperature.add(_g.NumberBox(
            value=-273.16, suffix='°C', tip='Last recorded temperature value.'), alignment=2).set_width(250).disable().set_style(style_1)
        
        self.grid_params.add(_g.Label('α:'), alignment=1).set_style(style_1)
        self.number_ra = self.grid_params.add(_g.TextBox(
            '17h 36m 14s', tip='Right Ascension.'), alignment=1,).set_width(250).disable().set_style(style_1)

        self.grid_params.add(_g.Label('δ:'), alignment=1).set_style(style_1)
        self.number_dec = self.grid_params.add(_g.NumberBox(
            47.0, suffix='°', tip='Declination.'), alignment=1).set_width(125).disable().set_style(style_1)
        self.grid_params.new_autorow()
        
        self.grid_params.add(_g.Label('Azimuth:'), alignment=1).set_style(style_1)
        self.number_lat = self.grid_params.add(_g.NumberBox(
            value=0.0, suffix='°', tip='Azimuth.'), alignment=1,).set_width(125).disable().set_style(style_1)

        self.grid_params.add(_g.Label(':'), alignment=1).set_style(style_1)
        self.number_log = self.grid_params.add(_g.NumberBox(
            value=0.0, suffix='°', tip='Altitude.'), alignment=1).set_width(125).disable().set_style(style_1)
        
        
        self.tabs = self.grid_bot.add(_g.TabArea(self.name+'.tabs'), alignment=0)
        
        self.tab_motors       = self.tabs.add_tab('Control')
        ...
        self.grid_buttons = self.tab_motors.place_object(_g.GridLayout())
        
        self.grid_location = self.grid_controls.place_object(_g.GridLayout())
        self.grid_controls.new_autorow()
        self.grid_angles = self.grid_controls.place_object(_g.GridLayout())
        self.grid_controls.new_autorow()
        ...
        self.grid_angles.new_autorow()
         
        self.grid_angles.add(_g.Label('α:'), alignment=1, column = 1).set_style(style_5)
        self.number_ra = self.grid_angles.add(_g.TextBox(
            '00h 00m 00s', tip='Right Ascension.'), alignment=1, column = 2).set_width(200).disable().set_style(style_6)
    
        self.grid_angles.add(_g.Label('Altitude:'), alignment=1, column = 3).set_style(style_5)
        self.number_dec = self.grid_angles.add(_g.NumberBox(
            0.0, suffix='°', tip='Declination.'), alignment=1, column = 4).set_width(125).disable().set_style(style_6)
        
        self.grid_angles.new_autorow()
        
        self.grid_angles.add(_g.Label('δ:'), alignment=1, column = 1).set_style(style_5)
        self.number_dec = self.grid_angles.add(_g.NumberBox(
            0.0, suffix='°', tip='Declination.'), alignment=1, column = 2).set_width(125).disable().set_style(style_6)
        
        self.grid_angles.add(_g.Label('Azimuth:'), alignment=1, column = 3).set_style(style_5)
        self.number_dec = self.grid_angles.add(_g.NumberBox(
            0.0, suffix='°', tip='Declination.'), alignment=1, column = 4).set_width(125).disable().set_style(style_6)
        
        self.grid_angles.set_row_stretch(0,5)
        self.grid_angles.set_row_stretch(1,2)
        self.grid_angles.set_row_stretch(2,2)
        self.grid_angles.set_row_stretch(3,10)
